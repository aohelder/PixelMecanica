<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Carros.aspx.cs" Inherits="PixelMecanica.Site.Carros" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="block_head">
        ...
        <ul>
            <li>
                <asp:Button ID="btnNovaOss" Text="Novo" PostBackUrl="~/Carro.aspx" runat="server"
                    CssClass="submit small" /></li>
        </ul>
    </div>
    <div class="block_content">
        <asp:Repeater ID="rptCarro" runat="server" OnItemDataBound="rptCarro_ItemDataBound"
            OnItemCommand="rptCarro_ItemCommand" ViewStateMode="Disabled">
            <HeaderTemplate>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lblFabricante" runat="server"></asp:Label>
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="icon-operacao">
                            <span class="icon-editar">
                                ...
                                <asp:LinkButton OnClientClick="return confirm('Confirma Excluir Carro ?');" CommandArgument="del"
